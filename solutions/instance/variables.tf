...
variable "kms_endpoint_type" {
  type        = string
  description = "The endpoint for communicating with the Key Protect (dedicated) instance. Possible values: `public`, `private`. Applies only if creating a Backup Vault with your own key."
  default     = "private"
  validation {
