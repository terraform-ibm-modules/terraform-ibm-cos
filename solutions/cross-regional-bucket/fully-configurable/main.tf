...
locals {
  ...
  kms_key_crn                = var.kms_encryption_enabled ? var.existing_kms_key_crn != null ? existing_kms_key_crn : module.kms[0].keys[format("%s.%s", var.cos_key_ring_name, var.cos_key_name)].crn : null
