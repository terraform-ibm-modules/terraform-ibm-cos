...
| <a name="input_resource_group_id"></a> [resource\_group\_id](#input\_resource\_group\_id) | The resource group ID where resources will be provisioned. If not provided creates resources in default resource group. | `string` | `""` | no |
