...
| <a name="input_bucket_endpoint"></a> [bucket\_endpoint](#input\_bucket\_endpoint) | The type of endpoint for the IBM provider to use to manage the bucket. (public, private, direct) | `string` | `"public"` | no |
