...
| <a name="input_allow_public_access_to_bucket"></a> [allow\_public\_access\_to\_bucket](#input\_allow\_public\_access\_to\_bucket) | Set it to `true` to allow the Object Storage bucket to be publicly accessible. | `bool` | `false` | no |
