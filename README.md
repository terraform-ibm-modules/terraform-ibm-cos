...
| <a name="input_service_endpoints_type"></a> [service\_endpoints\_type](#input\_service\_endpoints\_type) | The type of the service endpoint that can be set for the cloud object storage instance. | `string` | `"public-and-private"` | no |
