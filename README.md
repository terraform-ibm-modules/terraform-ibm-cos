...
| <a name="input_hmac_key_name"></a> [hmac\_key\_name](#input\_hmac\_key\_name) | Set as true to create a new HMAC key for the Cloud Object Storage instance. | `string` | `"my-key"` | no |
| <a name="input_hmac_key_role"></a> [hmac\_key\_role](#input\_hmac\_key\_role) | Set as true to create a new HMAC key for the Cloud Object Storage instance. | `string` | `"Manager"` | no |
