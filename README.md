...
| <a name="input_resource_group_id"></a> [resource\_group\_id](#input\_resource\_group\_id) | The resource group ID where resources will be provisioned. It is required for creating the Cloud Object Storage instance. | `string` | `null` | no |
