...
require (
	...
	github.com/terraform-ibm-modules/ibmcloud-terratest-wrapper v1.26.1
)
...
require (
	...
	github.com/IBM-Cloud/bluemix-go v0.0.0-20231207111833-cf0937e108a4 // indirect
	github.com/IBM-Cloud/power-go-client v1.5.7 // indirect
