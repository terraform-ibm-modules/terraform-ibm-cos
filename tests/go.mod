...
require (
	...
	github.com/terraform-ibm-modules/ibmcloud-terratest-wrapper v1.5.7
...
require (
	...
	github.com/IBM/go-sdk-core/v5 v5.13.0 // indirect
	github.com/IBM/platform-services-go-sdk v0.32.0 // indirect
