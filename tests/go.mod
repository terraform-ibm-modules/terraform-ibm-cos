...
require (
	...
	github.com/terraform-ibm-modules/ibmcloud-terratest-wrapper v1.2.10
)
...
require (
	...
	github.com/IBM/platform-services-go-sdk v0.30.0 // indirect
	...
	github.com/gruntwork-io/terratest v0.41.3 // indirect
