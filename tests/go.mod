...
require (
	...
	github.com/terraform-ibm-modules/ibmcloud-terratest-wrapper v1.5.4
...
require (
	...
	github.com/IBM/go-sdk-core/v5 v5.12.1 // indirect
	github.com/IBM/platform-services-go-sdk v0.31.6 // indirect
