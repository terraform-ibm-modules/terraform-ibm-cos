...
module "buckets" {
  ...
  bucket_configs = [
    # example of a KMS encrypted bucket
    {
    ...
    # example of a versioned bucket set up with a backup policy
    {
      ...
      backup_policies = [{
        ...
        target_backup_vault_crn   = "crn:v1:bluemix:public:cloud-object-storage:global:a/xxXXxxXXxXxXXXXxxXxxxXXXXxXXXXX:xxxxxxxx-XXXX-XXXX-XXXX-xxxxxxxx:backup-vault:my-vault"
...
>>>>>>> 73061751b297c8ff35a0f37161c2034d892fb4c0
